...
Adapted Repeater v4.8.1.3
Last Update Time: 2026-06-27 22:04:02
...
06-02 23:34:39 [INFO] repeater_main | Enter command from message: [脱敏处理]
...
06-02 23:35:06 [INFO] repeater_main | Response content score: 3.655717310298103
06-02 23:35:06 [WARNING] repeater_main | Response content score to high: 3.655717310298103, Expected to be below 1.0
...
[CQ:reply,id=[脱敏处理]][CQ:image,file=http://[脱敏处理]/files/render/434aba95-5167-47da-a7c0-0eed93deb9ab.png,cache=true,proxy=true][CQ:image,file=http://[脱敏处理]/files/render/016b0594-8375-434c-9c0d-398b20d5f76d.png,cache=true,proxy=true]
...
06-02 23:35:53 [SUCCESS] nonebot | OneBot V11 [脱敏处理] | [message.group.normal]: Message [脱敏处理] from [脱敏处理]@[群:[脱敏处理]] '[reply:id=[脱敏处理]]你喜欢哪个就选哪个'
...
06-02 23:35:53 [INFO] repeater_main | Enter command from message: [脱敏处理]
...
06-02 23:36:18 [INFO] repeater_main | Response content score: 1.7763310185185188
06-02 23:36:18 [WARNING] repeater_main | Response content score to high: 1.7763310185185188, Expected to be below 1.0
...
[CQ:reply,id=[脱敏处理]][CQ:image,file=http://[脱敏处理]/files/render/8f88a281-febe-470f-8474-15508f879061.png,cache=true,proxy=true][CQ:image,file=http://[脱敏处理]/files/render/022a8022-dd57-4dde-ba48-12e1a4f0eaac.png,cache=true,proxy=true]
06-02 23:36:24 [SUCCESS] nonebot | OneBot V11 [脱敏处理] | [message.group.normal]: Message [脱敏处理] from [脱敏处理]@[群:[脱敏处理]] '[at:qq=[脱敏处理]] '
